...
public class ThresholdSwitchScreen extends AbstractSimiScreen {
	...
	private final Text invertSignal = Lang.translateDirect("gui.threshold_switch.invert_signal");
	...
	protected void renderWindow(DrawContext graphics, int mouseX, int mouseY, float partialTicks) {
		...
		sprite.bind();
		graphics.drawTexture(sprite.location, (int) (x + upperBound) + 37, y + 20, (int) (sprite.startX + upperBound), sprite.startY,
			(int) (sprite.width - upperBound), sprite.height);
		graphics.drawTexture(sprite.location, x + 37, y + 42, sprite.startX, sprite.startY, (int) (lowerBound), sprite.height);
	...
	protected void send(boolean invert) {
		AllPackets.getChannel()
			.sendToServer(new ConfigureThresholdSwitchPacket(blockEntity.getPos(), offBelow.getState() / 100f,
