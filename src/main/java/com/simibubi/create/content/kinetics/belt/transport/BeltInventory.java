...
//			return Ending.FUNNEL;
	...
	public void read(NbtCompound nbt) {
		items.clear();
		nbt.getList("Items", NbtElement.COMPOUND_TYPE)
			.forEach(inbt -> items.add(TransportedItemStack.read((NbtCompound) inbt)));
	...
	public void eject(TransportedItemStack stack) {
		...
		Vec3d outMotion = Vec3d.of(belt.getBeltChainDirection())
