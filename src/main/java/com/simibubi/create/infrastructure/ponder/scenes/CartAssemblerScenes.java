...
public class CartAssemblerScenes {
	...
	public static void anchor(SceneBuilder scene, SceneBuildingUtil util) {
		...
		ElementLink<MinecartElement> cart = scene.special.createCart(util.vector.topOf(2, 0, 4), 90, MinecartEntity::new);
		...
		scene.idle(5);
		scene.world.replaceBlocks(util.select.fromTo(3, 3, 2, 1, 4, 2), Blocks.OAK_PLANKS.getDefaultState(), false);
